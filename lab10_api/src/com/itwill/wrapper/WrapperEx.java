...
public class WrapperEx {
	...
	public static void main(String[] args) {
		// Integer 타입 객체를 생성: int 값을 전달 받아서 Integer 객체 생성
		Integer number1 = Integer.valueOf(1);
		System.out.println(number1);

		// String 객체를 전달 받아서 Integer 객체 생성. 
		Integer number2 = Integer.valueOf("123"); 
		System.out.println(number2);
		
		// 문자열을 int 타입 값으로 변환하는 정적 메서드.
		int number3 = Integer.parseInt("321");
		System.out.println(number3);
		
		// auto-boxing: int 타입 값을 자동으로 Integer타입 객체로 생성. 
		Integer number4 = 4;
