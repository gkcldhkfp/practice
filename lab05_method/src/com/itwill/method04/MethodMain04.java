...
public class MethodMain04 {
	 ...
	 */
	public static boolean isEven(int x) { 		// 수식어 끼리의 순서는 상관없음
//		if (x % 2 == 0) {
//			return true;
//		} else {
//			return false;
...
//		return result;
	 ...
	 * @return 코드 값이 1, 3이면 "male", 코드 값이 2, 4 이면 "female".
	 * 만약 그 이외의 코드 값인 경우에는 "unknown"을 리턴.
	 */
	public static String parseGenderCode(int code) {

//		return (code == 1 || code == 3) ? "male" : ((code == 2 || code == 4) ? "female" : "unknown");
		String result = null;  // 반환값을 저장하기 위한 변수
