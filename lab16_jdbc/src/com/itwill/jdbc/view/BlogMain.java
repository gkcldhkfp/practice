...
public class BlogMain implements CreateNotify, UpdateNotify {
    ...
    private void initialize() {
        ...
        btnReadAll.setFont(new Font("D2Coding", Font.PLAIN, 21));
        ...
        btnCreate.setFont(new Font("D2Coding", Font.PLAIN, 21));
        buttonPanel.add(btnCreate);
        
        btnDetails = new JButton("상세보기");
        btnDetails.addActionListener((e) -> showDetailsFrame());
        btnDetails.setFont(new Font("D2Coding", Font.PLAIN, 21));
        buttonPanel.add(btnDetails);
        
        btnDelete = new JButton("삭제");
        btnDelete.addActionListener((e) -> deleteBlog());
        btnDelete.setFont(new Font("D2Coding", Font.PLAIN, 21));
