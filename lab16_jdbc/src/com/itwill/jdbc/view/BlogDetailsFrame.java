...
public class BlogDetailsFrame extends JFrame {
    ...
    private void initialize() {
        ...
        textTitle.setFont(new Font("D2Coding", Font.PLAIN, 23));
        ...
        textWriter.setFont(new Font("D2Coding", Font.PLAIN, 23));
        ...
        textCreated.setFont(new Font("D2Coding", Font.PLAIN, 18));
        ...
        textModified.setFont(new Font("D2Coding", Font.PLAIN, 18));
