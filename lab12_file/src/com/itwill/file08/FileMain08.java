 ...
 * 절대 경로(absolute path):
 * 	 - 시스템의 루트(C:\, D:\, /)부터 파일 또는 폴더가 있는 위치까지 찾아가는 방식.
 * 	 - (Windows 예) C:\study\gits\practice\lab12_file\data\hello.txt
...
public class FileMain08 {
	...
	public static void main(String[] args) {
		...
		String path = "C:\\study\\gits\\practice\\lab12_file"; // Windows 절대 경로 표현법
