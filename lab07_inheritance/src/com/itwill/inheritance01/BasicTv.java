...
public class BasicTv {
	...
	// 메서드
	/**
	 * TV가 켜져 있으면 끄고, TV가 꺼져 있으면 켬. powerOn의 값이 true면 false로 변경, powerOn의 값이 false면
	 * true로 변경.
	 * 
	 * @return powerOn의 값
	 */
	...
	/**
	 * channelDown. 현재 채널의 값을 1 감소 만약 현재 채널 값이 채널의 최소값(MIN_CHANNEL)인 경우, 채널의
	...
	/**
	 * volumeUp. 현재 음량의 값을 1 증가 만약 현재 음량값이 음량의 최댓값(MAX_VOLUME)인 경우, 음량을 변경하지 않음.
	 * 
	 * @return 바뀐 현재 음량 값.
	 */
	public int volumeUp() {
	...
	/**
	 * volumeDown. 현재 음량의 값을 1 감소 만약 현재 음량값이 음량의 최솟값(MIN_VOLUME)인 경우, 음량을 변경하지 않음.
	 * 
	 * @return 바뀐 현재 음량 값.
	 */
