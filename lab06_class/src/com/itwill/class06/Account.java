...
/**
 * 은행 계좌 정보. 속성: 계좌 번호, 잔고. 기능: 입금, 출금, 이체, 정보 출력.
 */
public class Account {
	...
	/**
	 * transfer(이체). 내 계좌의 잔고에서는 이체금액 amount를 빼고, 이체할 계좌 to의 잔고에서는 amount를 더함.
	 * 
	 * @param to     이체할 계좌(Account).
...
//		this.withdraw(amount);
	...
	public void info() {
		...
		System.out.println("게좌 번호: " + accountNo);
